...
local HiddenGui = (gethui or function()
...
local redzlib = {
    ...
    Info = { Version = "2.0.0" },
    Save = { UISize = { 434, 247 }, TabSize = 160, Theme = "Green" },
    Settings = {},
    Connection = {},
    Instances = {},
    Elements = {},
...
local Connections = redzlib.Connection
...
function Funcs:SetConnection(Configs)
    ...
    Connections[CName] = { Name = CName, Function = CFunc, Connection = CInstance[CSignal]:Connect(function(...)
        CFunc(...)
    end) }
...
local GetFlag, SetFlag, CheckFlag, FlagConnection
...
function redzlib:Notify(config)
    ...
    if NIcon then
        ...
        Create("ImageLabel", content, {
            ...
            Create("UICorner", { Name = "UICorner", CornerRadius = IconCornerRadius })
        })
    end

    if NSound then
        Create("Sound", notification, { Name = "Sound", SoundId = NSound }):Play()
    end
...
function redzlib:MakeWindow(Configs)
    ...
    function Window:MakeTab(paste, Configs)
        ...
        function Tab:AddDropdown(Configs)
            ...
            local AddNewOptions, GetOptions, AddOption, RemoveOption, Selected, SaveSelected
        ...
        function Tab:AddUserRoblox(Configs)
            ...
            local ImageId, bool = UserId and typeof(UserId) == "number" and Players:GetUserThumbnailAsync(UserId, Enum.ThumbnailType.HeadShot, Enum.ThumbnailSize.Size48x48)
